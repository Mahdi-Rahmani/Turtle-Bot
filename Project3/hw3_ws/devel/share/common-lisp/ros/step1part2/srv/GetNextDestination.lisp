...
(cl:defmethod cl:initialize-instance :after ((m <GetNextDestination-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNextDestination-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name step1part2-srv:<GetNextDestination-request> is deprecated: use step1part2-srv:GetNextDestination-request instead.")))

(cl:ensure-generic-function 'current_x-val :lambda-list '(m))
(cl:defmethod current_x-val ((m <GetNextDestination-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader step1part2-srv:current_x-val is deprecated.  Use step1part2-srv:current_x instead.")
  (current_x m))

(cl:ensure-generic-function 'current_y-val :lambda-list '(m))
(cl:defmethod current_y-val ((m <GetNextDestination-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader step1part2-srv:current_y-val is deprecated.  Use step1part2-srv:current_y instead.")
  (current_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNextDestination-request>)))
  ...
  "step1part2/GetNextDestinationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNextDestination-request)))
  "Returns string type for a service object of type 'GetNextDestination-request"
  "step1part2/GetNextDestinationRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetNextDestination-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetNextDestination-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name step1part2-srv:<GetNextDestination-response> is deprecated: use step1part2-srv:GetNextDestination-response instead.")))

(cl:ensure-generic-function 'next_x-val :lambda-list '(m))
(cl:defmethod next_x-val ((m <GetNextDestination-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader step1part2-srv:next_x-val is deprecated.  Use step1part2-srv:next_x instead.")
  (next_x m))

(cl:ensure-generic-function 'next_y-val :lambda-list '(m))
(cl:defmethod next_y-val ((m <GetNextDestination-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader step1part2-srv:next_y-val is deprecated.  Use step1part2-srv:next_y instead.")
  (next_y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetNextDestination-response>)))
  ...
  "step1part2/GetNextDestinationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetNextDestination-response)))
  "Returns string type for a service object of type 'GetNextDestination-response"
  "step1part2/GetNextDestinationResponse")
