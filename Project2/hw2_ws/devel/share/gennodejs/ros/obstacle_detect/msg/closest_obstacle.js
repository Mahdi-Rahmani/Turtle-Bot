...
class closest_obstacle {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('distnace')) {
        this.distnace = initObj.distnace
      }
      else {
        this.distnace = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [distnace]
    bufferOffset = _serializer.float64(obj.distnace, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [distnace]
    data.distnace = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.distnace !== undefined) {
      resolved.distnace = msg.distnace;
    }
    else {
      resolved.distnace = 0.0
    }
